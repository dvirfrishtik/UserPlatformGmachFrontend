            ...
            <div className="w-full min-w-0">
              ...
              <div className="hidden xl:flex items-center justify-between px-4 2xl:px-9 py-3 mb-4 gap-3 2xl:gap-8" style={{ backgroundColor: "var(--card)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", minHeight: "68px" }} dir="rtl">
                ...
                <div className="relative shrink-0" ref={actionsDropdownRefXl}>
                  ...
                  {isActionsDropdownOpen && <ActionsDropdown onClose={() => setIsActionsDropdownOpen(false)} onPurchaseUnits={() => setIsPurchaseWizardOpen(true)} onShowLoanSchedule={() => setIsLoanScheduleOpen(true)} />}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 mb-3">
                ...
                <div className="flex items-center gap-2 order-2 justify-end sm:justify-start shrink-0">
                  ...
                  <div className="flex p-1 gap-1" style={{ backgroundColor: "var(--page-section)", borderRadius: "300px" }}>
                    <button onClick={() => setActiveTab("table")} className="inline-flex items-center justify-center px-3 py-1.5 md:px-4 md:py-2 rounded-full transition-colors" style={{ backgroundColor: activeTab === "table" ? "#172554" : "transparent", fontSize: "13px", fontWeight: activeTab === "table" ? "var(--font-weight-semibold)" : "var(--font-weight-normal)", color: activeTab === "table" ? "#FFFFFF" : "var(--muted-foreground)", cursor: "pointer", border: "none", whiteSpace: "nowrap" }}>
                      טבלת יחידות
                    </button>
                    <button onClick={() => setActiveTab("timeline")} className="inline-flex items-center justify-center px-3 py-1.5 md:px-4 md:py-2 rounded-full transition-colors" style={{ backgroundColor: activeTab === "timeline" ? "#CCA559" : "transparent", fontSize: "13px", fontWeight: activeTab === "timeline" ? "var(--font-weight-semibold)" : "var(--font-weight-normal)", color: activeTab === "timeline" ? "#FFFFFF" : "var(--muted-foreground)", cursor: "pointer", border: "none", whiteSpace: "nowrap" }}>
                      ציר זמן תשלומים
                    </button>
                  </div>
                </div>
    ...
    <div style={{ width: "100%", height: "6px", backgroundColor: "var(--muted)", borderRadius: "100px", overflow: "hidden" }}>
      <div
        style={{
          height: "100%",
          width: `${progress}%`,
          backgroundColor: isFullyPaid ? "#CCA559" : "var(--primary)",
          borderRadius: "100px",
